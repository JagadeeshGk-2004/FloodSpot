...
function generateWebTests() {
  ...
  const cvScenarios = [
    ...
    "Computer Vision model inference trigger verification on upload",
    "Flood depth AI detection confidence score indicator DOM render",
    ...
    "AI flood detection rejection for non-water images (e.g. cat photo)",
    "Computer Vision inference API timeout fallback to manual depth entry",
    ...
    "Computer Vision model version hash logging in report submission metadata",
